...
| STT | Tên bảng              | Chức năng                                                  |
| --- | --------------------- | ---------------------------------------------------------- |
| 33  | graduation_periods    | Đợt xét tốt nghiệp (Ví dụ: Đợt 1 - 2024, Đợt 2 - 2024)     |
| 34  | graduation_conditions | Điều kiện xét tốt nghiệp (tín chỉ, điểm, công nợ, kỷ luật) |
| 35  | graduation_results    | Kết quả xét duyệt (trạng thái duyệt, quyết định, xếp loại) |

**XII. NHÓM THÔNG BÁO – HỆ THỐNG**
| STT | Tên bảng      | Chức năng                           |
| --- | ------------- | ----------------------------------- |
| 36  | notifications | Thông báo hệ thống                  |
| 37  | logs          | Nhật ký hoạt động (audit, truy vết) |
| 38  | settings      | Cấu hình hệ thống                   |

**XIII. NHÓM MỞ RỘNG THƯỜNG DÙNG**
| STT | Tên bảng   | Chức năng                     |
| --- | ---------- | ----------------------------- |
| 39  | documents  | Tài liệu học tập              |
| 40  | feedbacks  | Đánh giá giảng viên / môn học |
| 41  | attendance | Điểm danh sinh viên           |
